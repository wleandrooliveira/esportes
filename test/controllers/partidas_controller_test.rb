...
class PartidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partida" do
    assert_difference('Partida.count') do
      post partidas_url, params: { partida: { description: @partida.description, horario: @partida.horario, local: @partida.local, title: @partida.title } }
    end
  ...
  test "should update partida" do
    patch partida_url(@partida), params: { partida: { description: @partida.description, horario: @partida.horario, local: @partida.local, title: @partida.title } }
